...
export function FacetSuccessRate({ data, indexNameColorMap, typeNameMap }) {
  return (
    <Chart autoFit data={data} height={400} padding={[20, 20, 20, 70]} appendPadding={[10]}>
      <Legend
        visible={true}
        itemName={{
          formatter: (text, item) => {
      ...
      <Facet
        ...
        eachView={(view, facet) => {
          ...
          view
            ...
            .tooltip("timeDate*value*indexCode*type", (timeDate, value, indexCode, type) => {
              return {
                title: `日期：${timeDate}`,
                value: `${type} : ${value}%`,
                name: indexCode,
